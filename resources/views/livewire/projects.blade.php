<x-app-layout>
    <div class="max-w-5xl mx-auto my-12" wire:init="loadProjects()"> 
        ...
        <div id="projects" class="grid grid-cols-5">
            ...
            @endforeach
            <div id="project_add" class="h-full w-full border-dashed border-2 border-gray-300 aspect-square rounded-[1.25rem] text-8xl flex items-center justify-center text-slate-300 cursor-pointer select-none hover:bg-white transition-all" type="button" data-modal-toggle="defaultModal">
                +
            </div>
        </div>
    </div>
