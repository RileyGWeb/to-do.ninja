    ...
    <div id="deleteProjectConfirmationModal" tabindex="-2" aria-hidden="true" class="hidden flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full items-center justify-center" wire:ignore>
        <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <div class="p-6 space-y-6">
                    <button id="delete_button" class="w-full text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" data-modal-hide="deleteProjectConfirmationModal">Yes, delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function toggleConfirmationModal(projectId) {
            ...
            if (modalNode.classList.contains("hidden")) {
                ...
                modalButtonNode.setAttribute("onClick", "deleteProject(" + projectId + ")");
            } else {
